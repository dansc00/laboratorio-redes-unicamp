...
#define MAX_PAYLOAD 1024 // tamanho do payload
...
ssize_t write_echo(int file_descriptor, char *ptr_buffer, size_t n)
{
    size_t nleft = n;
    
}

void send_echo(int new_sock)
{
...
int main(int argc, char **argv)
{
    ...
    bind(sock, &server_addr, sizeof(server_addr)); // associa socket ao endereço
    ...
    while(1){
        ...
        new_sock = accept(sock, &client_addr, &client_len); // gera socket com nova conexão, preenche endereço com IP e porta do cliente
